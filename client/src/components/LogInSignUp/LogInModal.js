        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 backdrop-blur-sm flex justify-center items-center z-50">
            <div ref={contentRef} className="bg-white pt-6 w-1/4 rounded-lg shadow-lg sborder border-black p-6">
                ...
                <div className="flex items-center justify-center mb-5">
                    <button className="bg-cyan-400 hover:bg-cyan-600 text-white font-bold py-2 w-full rounded focus:outline-none focus:shadow-outline" type="button">
                        Log In
                    </button>
                </div>

                <div className='flex justify-center'>
                    <p>Don't have an account? <span onClick={switchLogToSign}>Create one</span></p>
                </div>
            </div>
        </div>
    );
